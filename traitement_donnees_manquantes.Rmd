...
preds <- predict(train_rpart, test_df, type="prob") %>%
  mutate(dominant_class=ifelse())
```
Ici nous constatons que nous avons réussi à estimer la modalité pour le facteur `sida` pour l'ensemble des valeurs manquantes.

...
Les patients ayant eux une charge virale "faible" au début du traitement ont été plus tolérent au traitement et ont eux leur traitement simplifier moins souvent que la moyenne, respectivement -11% et -5%. Par contre il y a eu plus d'échec thérapeutique, +4%. Les patientsavec une charge virale très élevés ont eux plus souvent une simplification de leur traitement, +7%.
